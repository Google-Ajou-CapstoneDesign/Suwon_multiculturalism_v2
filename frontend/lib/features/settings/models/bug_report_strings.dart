...
class BugReportStrings {
  ...
  static const hint = L10nText(
    ...
    tr: "Ekranı, yeniden oluşturma adımlarını ve beklenen davranışı açıklayın.",
  ...
  static const open = L10nText(
    ...
    tr: "E-posta uygulaması kullanarak gönder",
    zh: '通过邮件应用发送',
  ...
  static const note = L10nText(
    ...
    tr: "Raporu e-posta uygulamanızda inceleyin ve gönderin.",
    zh: '请在邮件应用中确认内容并发送。',
  ...
  static const copyFailed = L10nText(
    ...
    tr: "Kopyalanamadı. Lütfen metni manuel olarak kopyalayın.",
    zh: '无法复制，请手动复制内容。',
  ...
  static const failed = L10nText(
    ...
    tr: "E-posta uygulaması açılamadı. Raporu kopyalayın ve aşağıdaki adrese gönderin.",
